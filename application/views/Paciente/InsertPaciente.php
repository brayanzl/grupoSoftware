                    ...
                    <form id="formAccountSettings" method="POST" action="<?php echo base_url() . 'Pacientes/guardar'; ?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="apellidoPaterno" placeholder="Ingrese su Apellido " id="apellidoPaterno" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="lastName" class="form-label">Apellido Materno</label>
                                <input class="form-control" type="text" name="apellidoMaterno" placeholder="Ingrese su Apellido " id="apellidoMaterno" />
                            </div>
                            <div class="mb-3 col-md-6">
